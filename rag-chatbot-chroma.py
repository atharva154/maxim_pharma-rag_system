...
from retrieval_chroma import retrieve_from_knowledge_base, format_results
import sys
...
def answer_query(parameter_name, use_llm=True):
    """
    Answer query about a parameter using RAG with ChromaDB.
    ...
    """
    print(f"\n🔍 Searching ChromaDB for: {parameter_name}")
...
def interactive_mode():
    ...
    print("=" * 70)
    print("🤖 RAG Chatbot - BMR Parameter Lookup (ChromaDB Version)")
    print("=" * 70)
    print("\nCommands:")
